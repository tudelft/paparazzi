/* Automatically generated by gen_abi from /home/wblee/paparazzi/conf/abi.xml */
/* Version v5.14.0_stable-34-g4bc2cfa98 */
/* Please DO NOT EDIT */
...
typedef void (*abi_callbackVISUAL_DETECTION)(uint8_t sender_id, int16_t pixel_x, int16_t pixel_y, int16_t pixel_width, int16_t pixel_height, int32_t quality,int32_t quality_1,int32_t quality_2, int16_t extra);
...
static inline void AbiSendMsgVISUAL_DETECTION(uint8_t sender_id, int16_t pixel_x, int16_t pixel_y, int16_t pixel_width, int16_t pixel_height, int32_t quality,int32_t quality_1,int32_t quality_2, int16_t extra) {
  abi_event* e;
  ABI_FOREACH(abi_queues[ABI_VISUAL_DETECTION_ID],e) {
    if (e->id == ABI_BROADCAST || e->id == sender_id) {
      abi_callbackVISUAL_DETECTION cb = (abi_callbackVISUAL_DETECTION)(e->cb);
      cb(sender_id, pixel_x, pixel_y, pixel_width, pixel_height, quality,quality_1,quality_2, extra);
    }
  }
}
