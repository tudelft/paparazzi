...
#define	LINE_VBUS                      PAL_LINE(GPIOA, 9U)
#define	LINE_FMU_CH2                   PAL_LINE(GPIOA, 10U)
...
#define VAL_GPIOA_MODER                 (PIN_MODE_ANALOG(PA00_ADC1) | \
					 ...
					 PIN_MODE_INPUT(PA09_VBUS) | \
					 PIN_MODE_INPUT(PA10_FMU_CH2) | \
...
#define VAL_GPIOA_OTYPER                (PIN_OTYPE_PUSHPULL(PA00_ADC1) | \
					 ...
					 PIN_OTYPE_OPENDRAIN(PA09_VBUS) | \
					 PIN_OTYPE_OPENDRAIN(PA10_FMU_CH2) | \
...
#define VAL_GPIOA_OSPEEDR               (PIN_OSPEED_SPEED_VERYLOW(PA00_ADC1) | \
					 ...
					 PIN_OSPEED_SPEED_VERYLOW(PA09_VBUS) | \
					 PIN_OSPEED_SPEED_VERYLOW(PA10_FMU_CH2) | \
...
#define VAL_GPIOA_PUPDR                 (PIN_PUPDR_FLOATING(PA00_ADC1) | \
					 ...
					 PIN_PUPDR_PULLDOWN(PA09_VBUS) | \
					 PIN_PUPDR_PULLDOWN(PA10_FMU_CH2) | \
...
#define VAL_GPIOA_ODR                   (PIN_ODR_LEVEL_LOW(PA00_ADC1) | \
					 ...
					 PIN_ODR_LEVEL_LOW(PA09_VBUS) | \
					 PIN_ODR_LEVEL_HIGH(PA10_FMU_CH2) | \
...
#define VAL_GPIOA_AFRH			(PIN_AFIO_AF(PA08_CAN3_RX, 11) | \
					 PIN_AFIO_AF(PA09_VBUS, 0) | \
					 PIN_AFIO_AF(PA10_FMU_CH2, 0) | \
...
#define VAL_GPIOD_MODER                 (PIN_MODE_ALTERNATE(PD00_UART4_RX) | \
					 ...
					 PIN_MODE_INPUT(PD13_SERVO5) | \
					 PIN_MODE_INPUT(PD14_SERVO6) | \
...
#define VAL_GPIOD_OTYPER                (PIN_OTYPE_PUSHPULL(PD00_UART4_RX) | \
					 ...
					 PIN_OTYPE_OPENDRAIN(PD13_SERVO5) | \
					 PIN_OTYPE_OPENDRAIN(PD14_SERVO6) | \
...
#define VAL_GPIOD_OSPEEDR               (PIN_OSPEED_SPEED_HIGH(PD00_UART4_RX) | \
					 ...
					 PIN_OSPEED_SPEED_VERYLOW(PD13_SERVO5) | \
					 PIN_OSPEED_SPEED_VERYLOW(PD14_SERVO6) | \
...
#define VAL_GPIOD_PUPDR                 (PIN_PUPDR_FLOATING(PD00_UART4_RX) | \
					 ...
					 PIN_PUPDR_PULLDOWN(PD13_SERVO5) | \
					 PIN_PUPDR_PULLDOWN(PD14_SERVO6) | \
...
#define VAL_GPIOD_ODR                   (PIN_ODR_LEVEL_HIGH(PD00_UART4_RX) | \
					 ...
					 PIN_ODR_LEVEL_HIGH(PD13_SERVO5) | \
					 PIN_ODR_LEVEL_HIGH(PD14_SERVO6) | \
...
#define VAL_GPIOD_AFRH			(PIN_AFIO_AF(PD08_UART3_TX, 7) | \
					 ...
					 PIN_AFIO_AF(PD13_SERVO5, 0) | \
					 PIN_AFIO_AF(PD14_SERVO6, 0) | \
...
#define VAL_GPIOH_OSPEEDR               (PIN_OSPEED_SPEED_HIGH(PH00_OSC_IN) | \
					 ...
					 PIN_OSPEED_SPEED_VERYLOW(PH06_SERVO7) | \
					 PIN_OSPEED_SPEED_HIGH(PH07_I2C3_SCL) | \
					 PIN_OSPEED_SPEED_HIGH(PH08_I2C3_SDA) | \
					 PIN_OSPEED_SPEED_VERYLOW(PH09_SERVO8) | \
...
#define VAL_GPIOH_PUPDR                 (PIN_PUPDR_FLOATING(PH00_OSC_IN) | \
					 ...
					 PIN_PUPDR_PULLDOWN(PH06_SERVO7) | \
					 PIN_PUPDR_PULLUP(PH07_I2C3_SCL) | \
					 PIN_PUPDR_PULLUP(PH08_I2C3_SDA) | \
					 PIN_PUPDR_PULLDOWN(PH09_SERVO8) | \
