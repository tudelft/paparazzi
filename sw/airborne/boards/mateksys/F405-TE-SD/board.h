 ...
 * Board identifier.
 */
#define BOARD_MATEKF405_TE_SD
#define BOARD_NAME                  "MATEKSYS F405-TE-SD"
...
#define	PRESSURE_SENS                  0U
#define	SDCARD_CS                      1U
#define	SPI2_MISO                      2U
#define	SPI2_MOSI                      3U
#define	BATT_VOLTAGE_SENS              4U
#define	BATT_CURRENT_SENS              5U
#define	USART6_TX                      6U
#define	USART6_RX                      7U
#define	SERVO2                         8U
#define	SERVO1                         9U
#define	USART3_TX                      10U
#define	USART3_RX                      11U
#define	UART5_TX                       12U
#define	FLASH_CS                       13U
#define	SPI1_CS                        14U
...
#define	LINE_PINIO1                    PAL_LINE(GPIOA, 4U)
#define	LINE_SPI1_SCK                  PAL_LINE(GPIOA, 5U)
#define	LINE_SERVO10                   PAL_LINE(GPIOA, 6U)
#define	LINE_SPI1_MOSI                 PAL_LINE(GPIOA, 7U)
#define	LINE_SERVO4                    PAL_LINE(GPIOA, 8U)
...
#define	LINE_SERVO8                    PAL_LINE(GPIOA, 15U)

#define	LINE_RSSI_ADC_PIN              PAL_LINE(GPIOB, 0U)
#define	LINE_SERVO12                   PAL_LINE(GPIOB, 1U)
#define	LINE_BOOT1                     PAL_LINE(GPIOB, 2U)
#define	LINE_SERVO7                    PAL_LINE(GPIOB, 3U)
#define	LINE_SPI1_MISO                 PAL_LINE(GPIOB, 4U)
#define	LINE_PINIO2                    PAL_LINE(GPIOB, 5U)
#define	LINE_SERVO11                   PAL_LINE(GPIOB, 6U)
#define	LINE_I2C1_SDA                  PAL_LINE(GPIOB, 7U)
#define	LINE_I2C1_SCL                  PAL_LINE(GPIOB, 8U)
#define	LINE_BEEPER                    PAL_LINE(GPIOB, 9U)
#define	LINE_SERVO6                    PAL_LINE(GPIOB, 10U)
#define	LINE_SERVO5                    PAL_LINE(GPIOB, 11U)
#define	LINE_OSD_CS                    PAL_LINE(GPIOB, 12U)
#define	LINE_SPI2_SCK                  PAL_LINE(GPIOB, 13U)
#define	LINE_SERVO9                    PAL_LINE(GPIOB, 14U)
#define	LINE_SERVO3                    PAL_LINE(GPIOB, 15U)

#define	LINE_PRESSURE_SENS             PAL_LINE(GPIOC, 0U)
#define	LINE_SDCARD_CS                 PAL_LINE(GPIOC, 1U)
#define	LINE_SPI2_MISO                 PAL_LINE(GPIOC, 2U)
#define	LINE_SPI2_MOSI                 PAL_LINE(GPIOC, 3U)
#define	LINE_BATT_VOLTAGE_SENS         PAL_LINE(GPIOC, 4U)
#define	LINE_BATT_CURRENT_SENS         PAL_LINE(GPIOC, 5U)
#define	LINE_USART6_TX                 PAL_LINE(GPIOC, 6U)
#define	LINE_USART6_RX                 PAL_LINE(GPIOC, 7U)
#define	LINE_SERVO2                    PAL_LINE(GPIOC, 8U)
#define	LINE_SERVO1                    PAL_LINE(GPIOC, 9U)
#define	LINE_USART3_TX                 PAL_LINE(GPIOC, 10U)
#define	LINE_USART3_RX                 PAL_LINE(GPIOC, 11U)
#define	LINE_UART5_TX                  PAL_LINE(GPIOC, 12U)
#define	LINE_FLASH_CS                  PAL_LINE(GPIOC, 13U)
#define	LINE_SPI1_CS                   PAL_LINE(GPIOC, 14U)
...
#define VAL_GPIOA_MODER                 (PIN_MODE_ALTERNATE(UART4_TX) | \
					 ...
					 PIN_MODE_OUTPUT(PINIO1) | \
					 PIN_MODE_ALTERNATE(SPI1_SCK) | \
					 PIN_MODE_ALTERNATE(SERVO10) | \
...
#define VAL_GPIOA_OTYPER                (PIN_OTYPE_PUSHPULL(UART4_TX) | \
					 ...
					 PIN_OTYPE_PUSHPULL(PINIO1) | \
					 PIN_OTYPE_PUSHPULL(SPI1_SCK) | \
					 PIN_OTYPE_PUSHPULL(SERVO10) | \
...
#define VAL_GPIOA_OSPEEDR               (PIN_OSPEED_SPEED_HIGH(UART4_TX) | \
					 ...
					 PIN_OSPEED_SPEED_LOW(PINIO1) | \
					 PIN_OSPEED_SPEED_HIGH(SPI1_SCK) | \
					 PIN_OSPEED_SPEED_HIGH(SERVO10) | \
...
#define VAL_GPIOA_PUPDR                 (PIN_PUPDR_FLOATING(UART4_TX) | \
					 ...
					 PIN_PUPDR_FLOATING(PINIO1) | \
					 PIN_PUPDR_FLOATING(SPI1_SCK) | \
					 PIN_PUPDR_FLOATING(SERVO10) | \
...
#define VAL_GPIOA_ODR                   (PIN_ODR_LEVEL_HIGH(UART4_TX) | \
					 ...
					 PIN_ODR_LEVEL_LOW(PINIO1) | \
					 PIN_ODR_LEVEL_HIGH(SPI1_SCK) | \
					 PIN_ODR_LEVEL_LOW(SERVO10) | \
...
#define VAL_GPIOA_AFRL			(PIN_AFIO_AF(UART4_TX, 8) | \
					 ...
					 PIN_AFIO_AF(PINIO1, 0) | \
					 PIN_AFIO_AF(SPI1_SCK, 5) | \
					 PIN_AFIO_AF(SERVO10, 9) | \
					 PIN_AFIO_AF(SPI1_MOSI, 5))

#define VAL_GPIOA_AFRH			(PIN_AFIO_AF(SERVO4, 1) | \
					 ...
					 PIN_AFIO_AF(LED2, 0) | \
					 PIN_AFIO_AF(LED1, 0) | \
					 PIN_AFIO_AF(SERVO8, 1))

#define VAL_GPIOB_MODER                 (PIN_MODE_ANALOG(RSSI_ADC_PIN) | \
					 PIN_MODE_ALTERNATE(SERVO12) | \
					 PIN_MODE_INPUT(BOOT1) | \
					 PIN_MODE_ALTERNATE(SERVO7) | \
					 PIN_MODE_ALTERNATE(SPI1_MISO) | \
					 PIN_MODE_OUTPUT(PINIO2) | \
					 PIN_MODE_ALTERNATE(SERVO11) | \
					 ...
					 PIN_MODE_ALTERNATE(SERVO9) | \
					 PIN_MODE_ALTERNATE(SERVO3))

#define VAL_GPIOB_OTYPER                (PIN_OTYPE_PUSHPULL(RSSI_ADC_PIN) | \
					 PIN_OTYPE_PUSHPULL(SERVO12) | \
					 PIN_OTYPE_OPENDRAIN(BOOT1) | \
					 PIN_OTYPE_PUSHPULL(SERVO7) | \
					 PIN_OTYPE_PUSHPULL(SPI1_MISO) | \
					 PIN_OTYPE_PUSHPULL(PINIO2) | \
					 PIN_OTYPE_PUSHPULL(SERVO11) | \
					 ...
					 PIN_OTYPE_PUSHPULL(SERVO9) | \
					 PIN_OTYPE_PUSHPULL(SERVO3))

#define VAL_GPIOB_OSPEEDR               (PIN_OSPEED_SPEED_VERYLOW(RSSI_ADC_PIN) | \
					 PIN_OSPEED_SPEED_HIGH(SERVO12) | \
					 PIN_OSPEED_SPEED_VERYLOW(BOOT1) | \
					 PIN_OSPEED_SPEED_HIGH(SERVO7) | \
					 PIN_OSPEED_SPEED_HIGH(SPI1_MISO) | \
					 PIN_OSPEED_SPEED_LOW(PINIO2) | \
					 PIN_OSPEED_SPEED_HIGH(SERVO11) | \
					 ...
					 PIN_OSPEED_SPEED_HIGH(SERVO9) | \
					 PIN_OSPEED_SPEED_HIGH(SERVO3))

#define VAL_GPIOB_PUPDR                 (PIN_PUPDR_FLOATING(RSSI_ADC_PIN) | \
					 PIN_PUPDR_FLOATING(SERVO12) | \
					 PIN_PUPDR_PULLDOWN(BOOT1) | \
					 PIN_PUPDR_FLOATING(SERVO7) | \
					 PIN_PUPDR_FLOATING(SPI1_MISO) | \
					 PIN_PUPDR_FLOATING(PINIO2) | \
					 PIN_PUPDR_FLOATING(SERVO11) | \
					 ...
					 PIN_PUPDR_FLOATING(SERVO9) | \
					 PIN_PUPDR_FLOATING(SERVO3))

#define VAL_GPIOB_ODR                   (PIN_ODR_LEVEL_LOW(RSSI_ADC_PIN) | \
					 PIN_ODR_LEVEL_LOW(SERVO12) | \
					 PIN_ODR_LEVEL_HIGH(BOOT1) | \
					 PIN_ODR_LEVEL_LOW(SERVO7) | \
					 PIN_ODR_LEVEL_HIGH(SPI1_MISO) | \
					 PIN_ODR_LEVEL_LOW(PINIO2) | \
					 PIN_ODR_LEVEL_LOW(SERVO11) | \
					 ...
					 PIN_ODR_LEVEL_LOW(SERVO9) | \
					 PIN_ODR_LEVEL_LOW(SERVO3))

#define VAL_GPIOB_AFRL			(PIN_AFIO_AF(RSSI_ADC_PIN, 0) | \
					 PIN_AFIO_AF(SERVO12, 2) | \
					 PIN_AFIO_AF(BOOT1, 0) | \
					 PIN_AFIO_AF(SERVO7, 1) | \
					 PIN_AFIO_AF(SPI1_MISO, 5) | \
					 PIN_AFIO_AF(PINIO2, 0) | \
					 PIN_AFIO_AF(SERVO11, 2) | \
					 PIN_AFIO_AF(I2C1_SDA, 4))

#define VAL_GPIOB_AFRH			(PIN_AFIO_AF(I2C1_SCL, 4) | \
					 PIN_AFIO_AF(BEEPER, 0) | \
					 PIN_AFIO_AF(SERVO6, 1) | \
...
#define VAL_GPIOC_MODER                 (PIN_MODE_ANALOG(PRESSURE_SENS) | \
					 ...
					 PIN_MODE_ANALOG(BATT_VOLTAGE_SENS) | \
					 PIN_MODE_ANALOG(BATT_CURRENT_SENS) | \
					 ...
					 PIN_MODE_ALTERNATE(UART5_TX) | \
					 PIN_MODE_OUTPUT(FLASH_CS) | \
					 PIN_MODE_OUTPUT(SPI1_CS) | \
					 PIN_MODE_INPUT(OSC32_OUT))

#define VAL_GPIOC_OTYPER                (PIN_OTYPE_PUSHPULL(PRESSURE_SENS) | \
					 PIN_OTYPE_PUSHPULL(SDCARD_CS) | \
					 PIN_OTYPE_PUSHPULL(SPI2_MISO) | \
					 PIN_OTYPE_PUSHPULL(SPI2_MOSI) | \
					 PIN_OTYPE_PUSHPULL(BATT_VOLTAGE_SENS) | \
					 PIN_OTYPE_PUSHPULL(BATT_CURRENT_SENS) | \
					 ...
					 PIN_OTYPE_PUSHPULL(UART5_TX) | \
					 PIN_OTYPE_PUSHPULL(FLASH_CS) | \
					 PIN_OTYPE_PUSHPULL(SPI1_CS) | \
					 PIN_OTYPE_OPENDRAIN(OSC32_OUT))

#define VAL_GPIOC_OSPEEDR               (PIN_OSPEED_SPEED_VERYLOW(PRESSURE_SENS) | \
					 PIN_OSPEED_SPEED_HIGH(SDCARD_CS) | \
					 PIN_OSPEED_SPEED_HIGH(SPI2_MISO) | \
					 PIN_OSPEED_SPEED_HIGH(SPI2_MOSI) | \
					 PIN_OSPEED_SPEED_VERYLOW(BATT_VOLTAGE_SENS) | \
					 PIN_OSPEED_SPEED_VERYLOW(BATT_CURRENT_SENS) | \
					 ...
					 PIN_OSPEED_SPEED_HIGH(UART5_TX) | \
					 PIN_OSPEED_SPEED_HIGH(FLASH_CS) | \
					 PIN_OSPEED_SPEED_HIGH(SPI1_CS) | \
					 PIN_OSPEED_SPEED_VERYLOW(OSC32_OUT))

#define VAL_GPIOC_PUPDR                 (PIN_PUPDR_FLOATING(PRESSURE_SENS) | \
					 PIN_PUPDR_FLOATING(SDCARD_CS) | \
					 PIN_PUPDR_FLOATING(SPI2_MISO) | \
					 PIN_PUPDR_FLOATING(SPI2_MOSI) | \
					 PIN_PUPDR_FLOATING(BATT_VOLTAGE_SENS) | \
					 PIN_PUPDR_FLOATING(BATT_CURRENT_SENS) | \
					 ...
					 PIN_PUPDR_FLOATING(UART5_TX) | \
					 PIN_PUPDR_FLOATING(FLASH_CS) | \
					 PIN_PUPDR_FLOATING(SPI1_CS) | \
					 PIN_PUPDR_PULLDOWN(OSC32_OUT))

#define VAL_GPIOC_ODR                   (PIN_ODR_LEVEL_LOW(PRESSURE_SENS) | \
					 PIN_ODR_LEVEL_HIGH(SDCARD_CS) | \
					 PIN_ODR_LEVEL_HIGH(SPI2_MISO) | \
					 PIN_ODR_LEVEL_HIGH(SPI2_MOSI) | \
					 PIN_ODR_LEVEL_LOW(BATT_VOLTAGE_SENS) | \
					 PIN_ODR_LEVEL_LOW(BATT_CURRENT_SENS) | \
					 ...
					 PIN_ODR_LEVEL_HIGH(UART5_TX) | \
					 PIN_ODR_LEVEL_HIGH(FLASH_CS) | \
					 PIN_ODR_LEVEL_HIGH(SPI1_CS) | \
					 PIN_ODR_LEVEL_HIGH(OSC32_OUT))

#define VAL_GPIOC_AFRL			(PIN_AFIO_AF(PRESSURE_SENS, 0) | \
					 PIN_AFIO_AF(SDCARD_CS, 0) | \
					 PIN_AFIO_AF(SPI2_MISO, 5) | \
					 PIN_AFIO_AF(SPI2_MOSI, 5) | \
					 PIN_AFIO_AF(BATT_VOLTAGE_SENS, 0) | \
					 PIN_AFIO_AF(BATT_CURRENT_SENS, 0) | \
					 PIN_AFIO_AF(USART6_TX, 8) | \
					 PIN_AFIO_AF(USART6_RX, 8))

#define VAL_GPIOC_AFRH			(PIN_AFIO_AF(SERVO2, 3) | \
					 PIN_AFIO_AF(SERVO1, 3) | \
					 PIN_AFIO_AF(USART3_TX, 7) | \
					 PIN_AFIO_AF(USART3_RX, 7) | \
					 PIN_AFIO_AF(UART5_TX, 8) | \
...
#define AF_SERVO10                       9U
#define AF_LINE_SERVO10                  9U
...
#define SERVO10_TIM	 13
#define SERVO10_TIM_FN	 CH
#define SERVO10_TIM_CH	 1
#define SERVO10_TIM_AF	 9
#define SERVO4_TIM	 1
...
#define SERVO8_TIM_CH	 1
#define SERVO8_TIM_AF	 1
#define SERVO12_TIM	 3
