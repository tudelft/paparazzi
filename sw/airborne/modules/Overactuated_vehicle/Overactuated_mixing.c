...
void overactuated_mixing_run(void)
{
    ...
    if(radio_control.values[RADIO_MODE] >= 500 )
    {
        ...
        INDI_pseudocontrol[2] = acc_setpoint[2] - accel_vect_filt_control_rf[2];
            ...
            //Compute and transmit the messages to the AM7 module using unfiltered control input (they will be filtered in the Rpi!):
            ...
            //Compute and transmit the messages to the AM7 module using filtered control input:
