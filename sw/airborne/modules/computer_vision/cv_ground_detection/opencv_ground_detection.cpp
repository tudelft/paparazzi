...
int low_H = 35, low_S = 50, low_V = 50;
int high_H = 40, high_S = max_value, high_V = max_value;
int cropped_rect_x = 25,cropped_rect_y = 0,cropped_rect_w = 15,cropped_rect_h = 50; //The first 2 variables state where the southwest edge of the rectangle goes, and the other specify the width and height
