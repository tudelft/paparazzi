...
#ifndef DETECT_GATE_GD_MODULE_H
#define DETECT_GATE_GD_MODULE_H

#include <stdint.h>
#include "modules/computer_vision/cv.h"

// Module functions
extern void detect_gate_gd_init(void);
extern void detect_gate_gd_event(void);
