...
extern float oag_central_floor_frac; // central floor detection threshold as a fraction of area used for central ground detection
extern float oag_plant_frac;          // plant detection threshold as a fraction of area used for plant detection

extern void group_11_init(void);
extern void group_11_periodic(void);
