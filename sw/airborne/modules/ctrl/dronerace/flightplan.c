...
const struct dronerace_flightplan_item_struct gates[MAX_GATES] = {
    ...
    {   6.0,          0.0,          2.0,          RadOfDeg(0),      REGULAR,      NO_BRAKE,       1.0,                      1},
    {   10.0,         0.0,          2.0,          RadOfDeg(0),      REGULAR,      BRAKE,          0.5,                      0},
    {   11.5,         5.0,          2.0,          RadOfDeg(90),     REGULAR,      BRAKE,          1.0,                      0},
    {   9.0,          8.0,          2.0,          RadOfDeg(180),    REGULAR,      NO_BRAKE,       1.0,                      0},
    {   4.0,          8.0,          2.0,          RadOfDeg(180),    REGULAR,      BRAKE,          1.0,                      0},
    {   1.0,          6.0,          2.0,          RadOfDeg(-90),    VIRTUAL,      BRAKE,          0.0,                      0},
    {   4.0,          5.0,          2.0,          RadOfDeg(0),      JUNGLE,       BRAKE,          1.0,                      0},
    {   7.0,          8.0,          2.0,          RadOfDeg(-90),    VIRTUAL,      BRAKE,          0.0,                      0},
    {   7.0,          5.0,          2.0,          RadOfDeg(-90),    REGULAR,      BRAKE,          1.0,                      0},
    {   6.0,          0.0,          2.0,          RadOfDeg(180),    REGULAR,      BRAKE,          1.0,                      0}
};
