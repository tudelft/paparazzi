...
void ctrl_eff(void)
{
    ...
    float omega_r0 = actuator_state_filt_vect[2] < 2000 ? 2000 : actuator_state_filt_vect[2];
    float omega_l0 = actuator_state_filt_vect[3] < 2000 ? 2000 : actuator_state_filt_vect[3];
