...
#define IMU_ICM42688_SIGN_PRODUCT \
  (IMU_ICM42688_SIGN_VALUE(IMU_ICM42688_X_SIGN) * \
   IMU_ICM42688_SIGN_VALUE(IMU_ICM42688_Y_SIGN) * \
   IMU_ICM42688_SIGN_VALUE(IMU_ICM42688_Z_SIGN))

#define IMU_ICM42688_EVEN_PERMUTATION \
  ((IMU_ICM42688_CHAN_X == 0 && IMU_ICM42688_CHAN_Y == 1) || \
   (IMU_ICM42688_CHAN_X == 1 && IMU_ICM42688_CHAN_Y == 2) || \
   (IMU_ICM42688_CHAN_X == 2 && IMU_ICM42688_CHAN_Y == 0))

#if (IMU_ICM42688_EVEN_PERMUTATION && IMU_ICM42688_SIGN_PRODUCT < 0) || \
  (!IMU_ICM42688_EVEN_PERMUTATION && IMU_ICM42688_SIGN_PRODUCT > 0)
#error "ICM42688 channel/sign mapping must be right-handed"
#endif
