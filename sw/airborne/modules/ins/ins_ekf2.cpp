...
#elif defined(INS_EKF2_GPS_YAW_OFFSET) && defined(INS_EKF2_GPS_ANTENNA_DISTANCE) 
  if(ISFINITE(gps_relposned.relPosHeading) && gps_relposned.relPosValid && gps_relposned.diffSoln && gps_relposned.carrSoln >= 1 
  && fabsf(gps_relposned.relPosLength - INS_EKF2_GPS_ANTENNA_DISTANCE) <= INS_EKF2_MAX_REL_LENGTH_ERROR * INS_EKF2_GPS_ANTENNA_DISTANCE) {
