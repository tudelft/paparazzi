...
static void gps_ubx_parse_nav_relposned(struct GpsUbx *gubx)
{
  ...
  if (version <= NAV_RELPOSNED_VERSION) {
    ...
    if (relPosValid) {
      ...
      gps_relposned.relPosHPLength  = UBX_NAV_RELPOSNED_relPosHPLength(gubx->msg_buf);
      ...
      gps_relposned.accN      = UBX_NAV_RELPOSNED_accN(gubx->msg_buf);
      gps_relposned.accE      = UBX_NAV_RELPOSNED_accE(gubx->msg_buf);
      gps_relposned.accD      = UBX_NAV_RELPOSNED_accD(gubx->msg_buf);
      gps_relposned.accLength   = UBX_NAV_RELPOSNED_accLength(gubx->msg_buf);
      gps_relposned.accHeading  = UBX_NAV_RELPOSNED_accHeading(gubx->msg_buf);
