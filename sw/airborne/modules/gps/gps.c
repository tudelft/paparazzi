...
static void send_gps_rtk(struct transport_tx *trans, struct link_device *dev)
{
  pprz_msg_send_GPS_RTK(trans, dev, AC_ID,
                        ...
                        &gps_relposned.relPosN, &gps_relposned.relPosE, &gps_relposned.relPosD, &gps_relposned.relPosLength, &gps_relposned.relPosHeading,
                        &gps_relposned.relPosHPN, &gps_relposned.relPosHPE, &gps_relposned.relPosHPD, &gps_relposned.relPosHPLength,
                        &gps_relposned.accN, &gps_relposned.accE, &gps_relposned.accD, &gps_relposned.accLength, &gps_relposned.accHeading,
