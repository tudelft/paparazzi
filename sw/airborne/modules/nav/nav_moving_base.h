...
extern void nav_moving_base_set_active_sender(uint8_t sender_id);
extern void enforce_horizontal_bounds(struct EnuCoor_f* quantity, struct FloatVect2* bounds);
