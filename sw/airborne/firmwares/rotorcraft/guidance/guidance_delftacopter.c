...
float delftacopter_fwd_roll_igain = DC_FORWARD_ROLL_IGAIN;
float delftacopter_fwd_roll_trim = DC_FORWARD_ROLL_TRIM;
...
float delftacopter_fwd_pitch_trim = DC_FORWARD_PITCH_TRIM;
...
*/
  ...
  // For debugging
  ypr_sp->phi = ANGLE_BFP_OF_REAL(delftacopter_fwd_roll);
  ypr_sp->theta = ANGLE_BFP_OF_REAL(delftacopter_fwd_pitch);
  ypr_sp->psi = ANGLE_BFP_OF_REAL(delftacopter_fwd_yaw);
}
