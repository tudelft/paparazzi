                         ...
                         float F_obm_moments[3])
{
  ...
  float t8;
  /* CYCLONE_OBM_MOMENTS */
  /*     F_obm_moments = CYCLONE_OBM_MOMENTS(IN1,IN2,IN3,IN4,IN5,IN6) */
  /*     This function was generated by the Symbolic Math Toolbox version 24.2.
   */
  /*     2025-11-27 12:16:32 */
  t2 = u[0] * u[2];
  ...
  F_obm_moments[0] =
      ((coeff[20] * t8 + coeff[19] * t10 * body_vel[1]) - coeff[21] * t10 * rates[2]) -
      rates[1] * coeff[22] * rates[2];
  F_obm_moments[1] = (((((coeff[16] * (t2 + t3) + coeff[18] * (rates[0] - rates[2])) +
                         coeff[14] * (u_dot[0] + u_dot[1])) +
                        coeff[15] * (u[2] + u[3])) +
                       coeff[13] * t10 * body_vel[0]) -
                      coeff[12] * t10 * body_vel[2]) -
                     coeff[17] * t10 * body_vel[2] * (u[0] + u[1]);
  F_obm_moments[2] =
      ((-coeff[8] * t8 - coeff[9] * (t2 - t3)) - rates[0] * coeff[11] * rates[1]) +
