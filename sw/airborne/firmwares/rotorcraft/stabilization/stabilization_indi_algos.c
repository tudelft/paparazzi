...
{
  pprz_msg_send_CTL_ALLOC_PERF(trans, dev, AC_ID, (uint8_t*)&indi_ctl_alloc_algo, &cond_est, &gamma_used, &indi_max_rpm_scaler, (uint16_t*) &indi_ctl_alloc_imax, (uint16_t*) &iterations, (uint8_t*) &wls_error, (uint8_t*) &n_satch, (uint32_t*) &t_ctl_alloc_exec_us);
}
