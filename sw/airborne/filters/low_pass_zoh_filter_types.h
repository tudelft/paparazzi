 ...
 */
static inline void init_first_order_zoh_low_pass_array(const uint8_t n, struct FirstOrderZOHLowPass filter_array[restrict n], const float omega[restrict n], const float sample_time)
{
 ...
 */
static inline void update_first_order_zoh_low_pass_array(const uint8_t n, struct FirstOrderZOHLowPass filter_array[restrict n], const float input_array[restrict n])
{
  for (uint8_t i = 0; i < n; i++)
  {
 ...
 */
static inline void reset_first_order_zoh_low_pass_array(const uint8_t n, struct FirstOrderZOHLowPass filter_array[restrict n], const float value_array[restrict n])
{
  for (uint8_t i = 0; i < n; i++)
  {
 ...
 */
static inline void get_first_order_zoh_low_pass_array(const uint8_t n, const struct FirstOrderZOHLowPass filter_array[restrict n], float output_array[restrict n])
{
  for (uint8_t i = 0; i < n; i++)
  {
