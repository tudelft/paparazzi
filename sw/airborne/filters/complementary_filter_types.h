 ...
 */
static inline void init_first_order_complementary_vect3(struct FirstOrderComplementaryVect3 *filter, const struct FloatVect3 *cut_off, float sample_time)
{
 ...
 * @param[in] sample_time Sampling period in seconds.
 */
static inline void init_first_order_complementary_array(uint8_t n, struct FirstOrderComplementary filter_array[restrict n], const float cut_off[restrict n], float sample_time)
{
 ...
 */
static inline void reset_first_order_complementary_array(uint8_t n, struct FirstOrderComplementary filter_array[restrict n], const float value_array[restrict n])
{
  for (uint8_t i = 0; i < n; i++)
  {
 ...
 * @param[in] sample_time Sampling period in seconds.
 */
static inline void init_butterworth_2_complementary_vect3(struct Butterworth2ComplementaryVect3 *filter, const struct FloatVect3 *cut_off, float sample_time)
{
 ...
 * @param[in] value Value to reset the filters to.
 */
static inline void reset_butterworth_2_complementary_vect3(struct Butterworth2ComplementaryVect3 *filter, const struct FloatVect3 *value)
{
 ...
 * @param[in] value Value to reset the filters to.
 */
static inline void reset_butterworth_2_complementary_rates(struct Butterworth2ComplementaryVect3 *filter, const struct FloatRates *value)
{
 ...
 * @param[in] sample_time Sampling period in seconds.
 */
static inline void init_butterworth_2_complementary_array(uint8_t n, Butterworth2Complementary filter_array[restrict n], const float cut_off[restrict n], float sample_time)
{
  for (uint8_t i = 0; i < n; i++)
  {
 ...
 * @param[in] value_array Array of values to reset the filters to.
 */
static inline void reset_butterworth_2_complementary_array(uint8_t n, Butterworth2Complementary filter_array[restrict n], const float value_array[restrict n])
{
  for (uint8_t i = 0; i < n; i++)
  {
 ...
 * @param[in] sample_time Sampling period in seconds.
 */
static inline void init_butterworth_4_complementary_vect3(struct Butterworth4ComplementaryVect3 *filter, const struct FloatVect3 *cut_off, float sample_time)
{
 ...
 * @param[in] value Value to reset the filters to.
 */
static inline void reset_butterworth_4_complementary_vect3(struct Butterworth4ComplementaryVect3 *filter, const struct FloatVect3 *value)
{
 ...
 * @param[in] value Value to reset the filters to.
 */
static inline void reset_butterworth_4_complementary_rates(struct Butterworth4ComplementaryVect3 *filter, const struct FloatRates *value)
{
 ...
 */
static inline void init_butterworth_4_complementary_array(uint8_t n, Butterworth4Complementary filter_array[restrict n], const float cut_off[restrict n], float sample_time)
{
  for (uint8_t i = 0; i < n; i++)
  {
 ...
 * @param[in] value_array Array of values to reset the filters to.
 */
static inline void reset_butterworth_4_complementary_array(uint8_t n, Butterworth4Complementary filter_array[restrict n], const float value_array[restrict n])
{
  for (uint8_t i = 0; i < n; i++)
  {
