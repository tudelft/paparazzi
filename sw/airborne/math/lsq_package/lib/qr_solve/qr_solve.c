...
/*
  ...
  Parameters:
    ...
    Input, num_t DA, the multiplier of DX.

    Input, num_t DX[*], the first vector.

    Input, int INCX, the increment between successive entries of DX.

    Input/output, num_t DY[*], the second vector.
...
/*
  ...
  Parameters:
    ...
    Input, num_t DY[*], the second vector.

    Input, int INCY, the increment between successive entries in DY.

    Output, num_t DDOT, the sum of the product of the corresponding
...
/*
  ...
  Parameters:
    ...
    Input, num_t X[*], the vector whose norm is to be computed.

    Input, int INCX, the increment between successive entries of X.

    Output, num_t DNRM2, the Euclidean norm of X.
*/
{
  num_t absxi;
  int i;
...
/*
  ...
  Parameters:
    ...
    Input/output, num_t A[LDA*N].  On input, the matrix whose
    ...
    Input, num_t TOL, a relative tolerance used to determine the
    ...
    Output, num_t QRAUX[N], will contain extra information defining
...
/*
  ...
  Parameters:
    ...
    Input/output, num_t A(LDA,P).  On input, the N by P matrix
    ...
    Output, num_t QRAUX[P], contains further information required
    ...
    Workspace, num_t WORK[P].  WORK is not referenced if JOB == 0.
...
/*
  ...
  Parameters:
    ...
    Input/output, num_t A[LDA*N], an M by N matrix.
    ...
    Input, num_t B[M], the right hand side of the linear system.

    Output, num_t X[N], a least squares solution to the linear
    system.

    Output, num_t RSD[M], the residual, B - A*X.  RSD may
    overwrite B.
    ...
    Workspace, num_t QRAUX[N], required if ITASK = 1.
...
/*
  ...
  Parameters:
    ...
    Input, num_t A[LDA*N], the QR factorization information
    ...
    Output, num_t X[N], a least squares solution to the
    linear system.
    ...
    Input, num_t QRAUX[N], auxiliary information from DQRANK
...
/*
  ...
  Parameters:
    ...
    Input, num_t A[LDA*P], contains the output of DQRDC.
    ...
    Input, num_t QRAUX[P], the auxiliary output from DQRDC.

    Input, num_t Y[N], a vector to be manipulated by DQRSL.

    Output, num_t QY[N], contains Q * Y, if requested.

    Output, num_t QTY[N], contains Q' * Y, if requested.

    Output, num_t B[K], the solution of the least squares problem
      minimize norm2 ( Y - AK * B),
    if its computation has been requested.  Note that if pivoting was
    requested in DQRDC, the J-th component of B will be associated with
    column JPVT(J) of the original matrix A that was input into DQRDC.

    Output, num_t RSD[N], the least squares residual Y - AK * B,
    if its computation has been requested.  RSD is also the orthogonal
    projection of Y onto the orthogonal complement of the column space
    of AK.

    Output, num_t AB[N], the least squares approximation Ak * B,
...
/*
  ...
  Parameters:
    ...
    Input, num_t SA, the multiplier.

    Input/output, num_t X[*], the vector to be scaled.
...
/*
  ...
  Parameters:
    ...
    Input/output, num_t X[*], one of the vectors to swap.

    Input, int INCX, the increment between successive entries of X.

    Input/output, num_t Y[*], one of the vectors to swap.
...
/*
  ...
  Parameters:
    ...
    Input, num_t A[M*N], the matrix.

    Input, num_t B[M], the right hand side.

    Output, num_t QR_SOLVE[N], the least squares solution.
*/
{
  int ind; /* UNUSED; */
  (void)ind;
