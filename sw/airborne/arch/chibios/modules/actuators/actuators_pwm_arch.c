...
/**
 * All PWM outputs are active high by default.
 * A board file can override the output mode of an individual servo, which is
 * needed e.g. for pins connected to a complementary timer channel (TIMx_CHyN)
 * that must be driven with
 * (PWM_OUTPUT_ACTIVE_HIGH | PWM_COMPLEMENTARY_OUTPUT_ACTIVE_HIGH).
 */
#ifndef PWM_SERVO_0_OUTPUT_MODE
#define PWM_SERVO_0_OUTPUT_MODE PWM_OUTPUT_ACTIVE_HIGH
#endif
#ifndef PWM_SERVO_1_OUTPUT_MODE
#define PWM_SERVO_1_OUTPUT_MODE PWM_OUTPUT_ACTIVE_HIGH
#endif
#ifndef PWM_SERVO_2_OUTPUT_MODE
#define PWM_SERVO_2_OUTPUT_MODE PWM_OUTPUT_ACTIVE_HIGH
#endif
#ifndef PWM_SERVO_3_OUTPUT_MODE
#define PWM_SERVO_3_OUTPUT_MODE PWM_OUTPUT_ACTIVE_HIGH
#endif
#ifndef PWM_SERVO_4_OUTPUT_MODE
#define PWM_SERVO_4_OUTPUT_MODE PWM_OUTPUT_ACTIVE_HIGH
#endif
#ifndef PWM_SERVO_5_OUTPUT_MODE
#define PWM_SERVO_5_OUTPUT_MODE PWM_OUTPUT_ACTIVE_HIGH
#endif
#ifndef PWM_SERVO_6_OUTPUT_MODE
#define PWM_SERVO_6_OUTPUT_MODE PWM_OUTPUT_ACTIVE_HIGH
#endif
#ifndef PWM_SERVO_7_OUTPUT_MODE
#define PWM_SERVO_7_OUTPUT_MODE PWM_OUTPUT_ACTIVE_HIGH
#endif
#ifndef PWM_SERVO_8_OUTPUT_MODE
#define PWM_SERVO_8_OUTPUT_MODE PWM_OUTPUT_ACTIVE_HIGH
#endif
#ifndef PWM_SERVO_9_OUTPUT_MODE
#define PWM_SERVO_9_OUTPUT_MODE PWM_OUTPUT_ACTIVE_HIGH
#endif
#ifndef PWM_SERVO_10_OUTPUT_MODE
#define PWM_SERVO_10_OUTPUT_MODE PWM_OUTPUT_ACTIVE_HIGH
#endif
#ifndef PWM_SERVO_11_OUTPUT_MODE
#define PWM_SERVO_11_OUTPUT_MODE PWM_OUTPUT_ACTIVE_HIGH
#endif
#ifndef PWM_SERVO_12_OUTPUT_MODE
#define PWM_SERVO_12_OUTPUT_MODE PWM_OUTPUT_ACTIVE_HIGH
#endif
#ifndef PWM_SERVO_13_OUTPUT_MODE
#define PWM_SERVO_13_OUTPUT_MODE PWM_OUTPUT_ACTIVE_HIGH
#endif
#ifndef PWM_SERVO_14_OUTPUT_MODE
#define PWM_SERVO_14_OUTPUT_MODE PWM_OUTPUT_ACTIVE_HIGH
#endif
#ifndef PWM_SERVO_15_OUTPUT_MODE
#define PWM_SERVO_15_OUTPUT_MODE PWM_OUTPUT_ACTIVE_HIGH
#endif
#ifndef PWM_SERVO_16_OUTPUT_MODE
#define PWM_SERVO_16_OUTPUT_MODE PWM_OUTPUT_ACTIVE_HIGH
#endif
...
void actuators_pwm_arch_init(void)
{
  ...
  PWM_SERVO_0_CONF.channels[PWM_SERVO_0_CHANNEL].mode = PWM_SERVO_0_OUTPUT_MODE;
#endif
#ifdef PWM_SERVO_1
  gpio_setup_pin_af(PWM_SERVO_1_GPIO, PWM_SERVO_1_PIN, PWM_SERVO_1_AF, true);
  PWM_SERVO_1_CONF.channels[PWM_SERVO_1_CHANNEL].mode = PWM_SERVO_1_OUTPUT_MODE;
#endif
#ifdef PWM_SERVO_2
  gpio_setup_pin_af(PWM_SERVO_2_GPIO, PWM_SERVO_2_PIN, PWM_SERVO_2_AF, true);
  PWM_SERVO_2_CONF.channels[PWM_SERVO_2_CHANNEL].mode = PWM_SERVO_2_OUTPUT_MODE;
#endif
#ifdef PWM_SERVO_3
  gpio_setup_pin_af(PWM_SERVO_3_GPIO, PWM_SERVO_3_PIN, PWM_SERVO_3_AF, true);
  PWM_SERVO_3_CONF.channels[PWM_SERVO_3_CHANNEL].mode = PWM_SERVO_3_OUTPUT_MODE;
#endif
#ifdef PWM_SERVO_4
  gpio_setup_pin_af(PWM_SERVO_4_GPIO, PWM_SERVO_4_PIN, PWM_SERVO_4_AF, true);
  PWM_SERVO_4_CONF.channels[PWM_SERVO_4_CHANNEL].mode = PWM_SERVO_4_OUTPUT_MODE;
#endif
#ifdef PWM_SERVO_5
  gpio_setup_pin_af(PWM_SERVO_5_GPIO, PWM_SERVO_5_PIN, PWM_SERVO_5_AF, true);
  PWM_SERVO_5_CONF.channels[PWM_SERVO_5_CHANNEL].mode = PWM_SERVO_5_OUTPUT_MODE;
#endif
#ifdef PWM_SERVO_6
  gpio_setup_pin_af(PWM_SERVO_6_GPIO, PWM_SERVO_6_PIN, PWM_SERVO_6_AF, true);
  PWM_SERVO_6_CONF.channels[PWM_SERVO_6_CHANNEL].mode = PWM_SERVO_6_OUTPUT_MODE;
#endif
#ifdef PWM_SERVO_7
  gpio_setup_pin_af(PWM_SERVO_7_GPIO, PWM_SERVO_7_PIN, PWM_SERVO_7_AF, true);
  PWM_SERVO_7_CONF.channels[PWM_SERVO_7_CHANNEL].mode = PWM_SERVO_7_OUTPUT_MODE;
#endif
#ifdef PWM_SERVO_8
  gpio_setup_pin_af(PWM_SERVO_8_GPIO, PWM_SERVO_8_PIN, PWM_SERVO_8_AF, true);
  PWM_SERVO_8_CONF.channels[PWM_SERVO_8_CHANNEL].mode = PWM_SERVO_8_OUTPUT_MODE;
#endif
#ifdef PWM_SERVO_9
  gpio_setup_pin_af(PWM_SERVO_9_GPIO, PWM_SERVO_9_PIN, PWM_SERVO_9_AF, true);
  PWM_SERVO_9_CONF.channels[PWM_SERVO_9_CHANNEL].mode = PWM_SERVO_9_OUTPUT_MODE;
#endif
#ifdef PWM_SERVO_10
  gpio_setup_pin_af(PWM_SERVO_10_GPIO, PWM_SERVO_10_PIN, PWM_SERVO_10_AF, true);
  PWM_SERVO_10_CONF.channels[PWM_SERVO_10_CHANNEL].mode = PWM_SERVO_10_OUTPUT_MODE;
#endif
#ifdef PWM_SERVO_11
  gpio_setup_pin_af(PWM_SERVO_11_GPIO, PWM_SERVO_11_PIN, PWM_SERVO_11_AF, true);
  PWM_SERVO_11_CONF.channels[PWM_SERVO_11_CHANNEL].mode = PWM_SERVO_11_OUTPUT_MODE;
#endif
#ifdef PWM_SERVO_12
  gpio_setup_pin_af(PWM_SERVO_12_GPIO, PWM_SERVO_12_PIN, PWM_SERVO_12_AF, true);
  PWM_SERVO_12_CONF.channels[PWM_SERVO_12_CHANNEL].mode = PWM_SERVO_12_OUTPUT_MODE;
#endif
#ifdef PWM_SERVO_13
  gpio_setup_pin_af(PWM_SERVO_13_GPIO, PWM_SERVO_13_PIN, PWM_SERVO_13_AF, true);
  PWM_SERVO_13_CONF.channels[PWM_SERVO_13_CHANNEL].mode = PWM_SERVO_13_OUTPUT_MODE;
#endif
#ifdef PWM_SERVO_14
  gpio_setup_pin_af(PWM_SERVO_14_GPIO, PWM_SERVO_14_PIN, PWM_SERVO_14_AF, true);
  PWM_SERVO_14_CONF.channels[PWM_SERVO_14_CHANNEL].mode = PWM_SERVO_14_OUTPUT_MODE;
#endif
#ifdef PWM_SERVO_15
  gpio_setup_pin_af(PWM_SERVO_15_GPIO, PWM_SERVO_15_PIN, PWM_SERVO_15_AF, true);
  PWM_SERVO_15_CONF.channels[PWM_SERVO_15_CHANNEL].mode = PWM_SERVO_15_OUTPUT_MODE;
#endif
#ifdef PWM_SERVO_16
  gpio_setup_pin_af(PWM_SERVO_16_GPIO, PWM_SERVO_16_PIN, PWM_SERVO_16_AF, true);
  PWM_SERVO_16_CONF.channels[PWM_SERVO_16_CHANNEL].mode = PWM_SERVO_16_OUTPUT_MODE;
#endif
