...
#if defined(LINE_PWM_INPUT2)
#define PWM_INPUT2_ICU            CONCAT_BOARD_PARAM(ICUD, PWM_INPUT2_TIM)
#define PWM_INPUT2_CHANNEL        CONCAT_BOARD_PARAM(ICU_CHANNEL_, PWM_INPUT2_TIM_CH)
#define PWM_INPUT2_GPIO_PORT      PAL_PORT(LINE_PWM_INPUT2)
#define PWM_INPUT2_GPIO_PIN       PAL_PAD(LINE_PWM_INPUT2)
#define PWM_INPUT2_GPIO_AF        AF_LINE_PWM_INPUT2
#endif

#define RC_PPM_TICKS_PER_USEC 6
#define PPM_TIMER_FREQUENCY 6000000
#define PPM_CHANNEL CONCAT_BOARD_PARAM(ICU_CHANNEL_, PWM_INPUT1_TIM_CH)
#define PPM_TIMER CONCAT_BOARD_PARAM(ICUD, PWM_INPUT1_TIM)
