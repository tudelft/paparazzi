...
if __name__ == '__main__':
    ...
    print("\nNederdrone configuration:")
    mm.clear_rotors()
    mm.add_rotor(0.15, -0.79, mm.CW)
    mm.add_rotor(0.15, -0.51, mm.CCW)
    mm.add_rotor(0.15, -0.22, mm.CW)
    mm.add_rotor(0.15,  0.22, mm.CCW)
    mm.add_rotor(0.15,  0.51, mm.CW)
    mm.add_rotor(0.15,  0.79, mm.CCW)
