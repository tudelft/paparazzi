...
#:
#: The 13-router safety envelope is generated by mesh_phase_optimizer.py:
#: 32 slots x 375 ms, 12 s superframe, 36 % channel utilisation, and one frame
#: peak cache depth. This trades dense-fleet update rate for multi-hop reach and
#: fault tolerance while sparse fleets automatically reclaim unused slots.
RELAY_AC_IDS = None
