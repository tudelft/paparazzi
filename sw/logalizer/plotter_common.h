...
public:
     ...
     * @param overlayParent The parent viewport (must be QChartView window) where the overlay resides.
     */
...
protected:
    /**
     * @brief Intercepts generic events to handle automated snapping logic when the window is resized.
    ...
    bool eventFilter(QObject *obj, QEvent *event) override {
        // Only react to legitimate resizing limits so that the floating widget correctly snaps layout coordinates
