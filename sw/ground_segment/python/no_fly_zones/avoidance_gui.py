...
class Avoidance_GUI(threading.Thread):
    def __init__(self, detm, resm, cas, reduced_tla_step, extended_tla, reduced_tla_margin, reduced_resolution_margin):
    ...
    def run(self):
        ...
        # Detection Margin
        self.w_detm_slider = tk.Scale(self.master, from_=0., to=100., orient=tk.HORIZONTAL)
        ...
        self.w_reduced_resolution_margin_slider = tk.Scale(self.master, from_=0, to=100., orient=tk.HORIZONTAL)
        ...
        # Resolution margin
        self.w_resm_slider = tk.Scale(self.master, from_=0., to=100., orient=tk.HORIZONTAL)
        ...
        # Commanced airspeed
        self.w_cas_slider = tk.Scale(self.master, from_=0., to=100., orient=tk.HORIZONTAL)
        ...
        # extended tla
        self.w_extended_tla_slider = tk.Scale(self.master, from_=0., to=50., orient=tk.HORIZONTAL)
        ...
        #reduced tla margin
        self.w_reduced_tla_margin_slider = tk.Scale(self.master, from_=0., to =25., orient=tk.HORIZONTAL)
