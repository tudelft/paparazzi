...
#define PRINT_GPSDATA_TO_TERMINAL false
      ...
      switch(gps_ubx.msg_id) {
        case UBX_NAV_PVT_ID: {
          ...
          IvySendMsg("ground FLIGHT_PARAM GCS %f %f %f %f %f %f %f %f %f %f %f %d %f",
            ...
            if (PRINT_GPSDATA_TO_TERMINAL) printf("ground FLIGHT_PARAM GCS %f %f %f %f %f %f %f %f %f %f %f %d %f \n",
                0.0, // roll,
                0.0, // pitch,
                ground_heading, // heading
                lat,
            ...
            if (PRINT_GPSDATA_TO_TERMINAL) printf("TARGET_POS %d %d %d %d %d %f %f %f %f %i \n",
                ac_id,
                ac_id,
                (int)(lat * 1e7),
                (int)(lon * 1e7),
...
int main(int argc, char** argv) {
  ...
  int c;
  int option_index = 0;
  while((c = getopt_long(argc, argv, "f:i:e:hv", long_options, &option_index)) != -1) {
    switch (c) {
      case 'i':
        ac_id = atoi(optarg);
        break;
