...
double c_compute_cost_and_gradient_fir(
    ...
    double W_act_motor_du, double W_act_theta_du, double W_act_tilt_el_du,
    double W_act_tilt_az_du, double W_act_phi_du, double W_act_ailerons_du,
    ...
    const double previous_controls[15], double l_1, double l_2, double l_3,
