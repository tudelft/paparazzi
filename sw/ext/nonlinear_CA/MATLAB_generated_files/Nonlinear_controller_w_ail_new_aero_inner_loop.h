 ...
 * File: Nonlinear_controller_w_ail_new_aero_inner_loop.h
 *
 * MATLAB Coder version            : 23.2
 * C/C++ source code generated on  : 11-Oct-2024 12:47:26
 */

#ifndef NONLINEAR_CONTROLLER_W_AIL_NEW_AERO_INNER_LOOP_H
#define NONLINEAR_CONTROLLER_W_AIL_NEW_AERO_INNER_LOOP_H
...
extern void Nonlinear_controller_w_ail_new_aero_inner_loop(
    ...
    double W_act_tilt_az_speed, double W_act_ailerons_const,
    ...
    double Beta, double gamma_quadratic_du, double desired_motor_value,
    ...
    double prop_theta, double max_airspeed, double wing_span, double u_out[13],
    double residuals[6], double *elapsed_time, double *N_iterations,
    double *N_evaluation, double *exitflag);

extern void Nonlinear_controller_w_ail_new_aero_inner_loop_initialize(void);

extern void Nonlinear_controller_w_ail_new_aero_inner_loop_terminate(void);
...
#endif
/*
 * File trailer for Nonlinear_controller_w_ail_new_aero_inner_loop.h
 *
 * [EOF]
 */
