 ...
 * File: compute_acc_nonlinear_control_rf_w_Mx_noah.c
 *
    ...
    double wing_span, double wing_chord, double accelerations_array[6])
{
  ...
  accelerations_array[3] =
      -(((((((((((l_1 * t54 - l_1 * t52) - l_2 * t46) + l_2 * t44) +
        ...
        t69 * wing_span *
            ((((((t74 * 0.01228634392023026 - t68 * 0.01228634392023026) +
                 Omega_1_scaled * Omega_1_scaled * t7 * 0.0075456152077779167) -
                Omega_2_scaled * Omega_2_scaled * t8 * 0.0075456152077779167) -
               t74 * t31 * 0.020516396677824081) +
              ((((t68 * t31 * 0.020516396677824081 +
                  Omega_1_scaled * t16 * t37 * 0.0046429750925043979) -
                 Omega_2_scaled * t17 * t36 * 0.0046429750925043979) +
                Omega_2_scaled * t18 * t36 * 0.0064381447596962606) -
               Omega_1_scaled * t19 * t37 * 0.0064381447596962606)) +
             (Omega_1_scaled * (t7 * t7) * t19 * -0.0039349871274520724 +
              Omega_2_scaled * (t8 * t8) * t18 * 0.0039349871274520724)) /
            2.0) /
      I_xx;
  t74 = I_xx * p;
...
/*
 * File trailer for compute_acc_nonlinear_control_rf_w_Mx_noah.c
 *
 * [EOF]
 */
