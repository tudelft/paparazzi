 ...
 * Return Type  : void
 */
void b_setProblemType(o_struct_T *obj, int PROBLEM_TYPE)
{
  int i;
  int idx;
  int idx_col;
    ...
    if (obj->probType != 4) {
      ...
      for (idx_col = idxStartIneq; idx_col <= i; idx_col++) {
        ...
        if (obj->Wid[idx_col - 1] == 3) {
          ...
          idx = i1 + 12;
          if (idx >= 14) {
            memset(&obj->ATwset[idx_lb + 14], 0,
                   (unsigned int)(((idx + idx_lb) - idx_lb) - 13) *
                       sizeof(double));
          }
          ...
          if (i1 <= 13) {
            memset(&obj->ATwset[i1 + idx_lb], 0,
                   (unsigned int)(((idx_lb - i1) - idx_lb) + 14) *
                       sizeof(double));
          }
        }
      }
 ...
 * Return Type  : void
 */
void setProblemType(m_struct_T *obj, int PROBLEM_TYPE)
{
  int i;
  int idx;
  int idx_col;
