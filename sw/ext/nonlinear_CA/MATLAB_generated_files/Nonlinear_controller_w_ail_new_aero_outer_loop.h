 ...
 * File: Nonlinear_controller_w_ail_new_aero_outer_loop.h
 *
 * MATLAB Coder version            : 23.2
 * C/C++ source code generated on  : 11-Oct-2024 12:51:02
 */

#ifndef NONLINEAR_CONTROLLER_W_AIL_NEW_AERO_OUTER_LOOP_H
#define NONLINEAR_CONTROLLER_W_AIL_NEW_AERO_OUTER_LOOP_H
...
extern void Nonlinear_controller_w_ail_new_aero_outer_loop(
    ...
    double vert_acc_margin, double p_body_current, double q_body_current,
    ...
    double angular_proportional_gains[3], double angular_derivative_gains[3],
    double theta_hard_max, double theta_hard_min, double phi_hard_max,
    double phi_hard_min, double k_d_airspeed, double des_psi_dot,
    const double current_accelerations[6], const double u_init[15],
    double use_u_init, double induced_failure, double W_act_motor_failure,
    ...
    double W_dv_6_failure, double gamma_quadratic_du_failure, double power_Cd_0,
    ...
    double prop_theta, double max_airspeed, double wing_span, double u_out[15],
...
extern void Nonlinear_controller_w_ail_new_aero_outer_loop_initialize(void);

extern void Nonlinear_controller_w_ail_new_aero_outer_loop_terminate(void);
...
#endif
/*
 * File trailer for Nonlinear_controller_w_ail_new_aero_outer_loop.h
 *
 * [EOF]
 */
