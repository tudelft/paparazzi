 ...
 * File: AM_Nonlinear_CA_nico_test.h
 *
 * MATLAB Coder version            : 5.4
 * C/C++ source code generated on  : 26-Oct-2023 15:50:45
 */

#ifndef AM_NONLINEAR_CA_NICO_TEST_H
#define AM_NONLINEAR_CA_NICO_TEST_H
...
extern void AM_Nonlinear_CA_nico_test(
    ...
    double W_act_motor_const, double W_MOTOR_FAILURE_WEIGHT,
    ...
    double gamma_quadratic_du, double gamma_quadratic_du2,
    ...
    const double previous_controls[15], double k_alt_tilt_constraint,
...
extern void AM_Nonlinear_CA_nico_test_initialize(void);

extern void AM_Nonlinear_CA_nico_test_terminate(void);
...
#endif
/*
 * File trailer for AM_Nonlinear_CA_nico_test.h
 *
 * [EOF]
 */
