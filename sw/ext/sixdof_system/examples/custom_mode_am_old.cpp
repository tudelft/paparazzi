...
static void ivy_get_attitude_and_ned_pos(IvyClientPtr app, void *user_data, int argc, char *argv[])
{
  if (argc != 12)
  {
    ...
    euler_angles[0] = (float) atof(argv[6])*0.0139882*M_PI/180; 
    euler_angles[1] = (float) atof(argv[7])*0.0139882*M_PI/180;
    euler_angles[2] = (float) atof(argv[8])*0.0139882*M_PI/180;
