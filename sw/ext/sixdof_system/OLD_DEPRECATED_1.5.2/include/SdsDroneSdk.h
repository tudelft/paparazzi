...
namespace Sds {
    namespace DroneSDK {
        ...
        /**
         * @class Version
         * @brief A class representing the version of the shared library.
         *
         * This class provides methods to get the version (major, minor, patch) of the shared library,
         * compare versions, obtain a string representation, and check for specific features.
         */
        ...
        public:
            ...
            /**
             * @brief Check if the version has a specific feature.
             *
             * @param feature_name The name of the feature to check for.
             * @return True if the version has the specified feature, false otherwise.
             */
        ...
        struct SDS_API Config6Dof {
            ...
            bool skip_gyro_calibration { false };     ///< set to true to skip gyro calibration, this will speed up the initialization process.
            ShutterSettings shutter_settings { getShutterSettingsAuto() };
            //uint8_t fixed_shutter_value { 5 };        ///< fixed shutter value, use 0 for the shortest shutter and 16 for the longest shutter. Set to 63 to enable auto-shutter. (Optional)
